...
<% String ano = request.getParameter("ano");
                ...
                PreparedStatement st = conn.prepareStatement("Select count(b_id) as b from baggage inner join flight on baggage.f_id=flight.f_id inner join airport on flight.destination=airport.city and airport.ano=?");
                st.setString(1,ano);
                ...
                %>
               <br> <b><center>
				  <b><center>number of baggages as requested is:<%=rs.getString("b")%> 
                </center></b></div>
