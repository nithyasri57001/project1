...
<%
                ...
                PreparedStatement st = conn.prepareStatement("Select ano, max(f) as no from (Select ano, count(f_id) as f from (select f_id, ano from flight inner join airline on flight.air_id=airline.air_id) group by ano ) group  by ano");
               ...
               ResultSet rs = st.executeQuery();
                ...
                rs.next(); %></div>
               <br> <b><center>
               <u>Airport With Max No. Of flights<br></u>
                AirPort No <%= rs.getString("ano") %><br>
                Number Of Flights <%=rs.getString("no") %><br>
