...
try{
	...
	String strQuery = "SELECT COUNT(*) FROM passenger";
	...
	if(i>0){
		PreparedStatement gh = con.prepareStatement("select p_id from passenger where pass_no = ?");
		gh.setString(1,pid);
 
        ResultSet rs = gh.executeQuery();
        rs.next(); %><div>
        <b><center>passenger id is:<%=rs.getString("p_id") %></div> <%
