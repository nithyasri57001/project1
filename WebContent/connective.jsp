...
String to = request.getParameter("to");
                ...
                PreparedStatement st = conn.prepareStatement("select a.f_id as fi,a.totalavail as ft,a.nobooked as fn ,b.totalavail as bt ,b.nobooked as bn , a.destination as ad, b.f_id as bf from flight a,flight b where a.destination=b.splace and a.day=b.day and a.day= ? and a.splace= ? and b.destination= ? ");
                st.setString(2,from);
                st.setString(3,to);
                st.setString(1,day);
...
<td><b>f2ID        </b></td>
                ...
                while(rs.next())
                {String n=rs.getString("ft");
                String p=rs.getString("fn");
                String m=rs.getString("bt");
                String q=rs.getString("bn");
                if(n!=p && m!=q){
                %>
<tr bgcolor="#8FBC8F">

<td><%=rs.getString("fi")%></td>
<td><%=rs.getString("ad")%></td>
<td><%=rs.getString("bf")%></td>
