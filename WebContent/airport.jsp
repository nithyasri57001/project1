...
<% String air = request.getParameter("air");
                ...
                PreparedStatement st = conn.prepareStatement("select * from airport where ano = ?");
                PreparedStatement sc = conn.prepareStatement("select * from employee where ano = ?");
                st.setString(1,air);
                sc.setString(1,air);
...
<td><%=rc.getString("empno")%></td>
<td><%=rc.getString("ename")%></td>
<td><%=rc.getString("designation")%></td>
