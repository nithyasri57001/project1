...
<%
                ...
                PreparedStatement st = conn.prepareStatement("select count(p_id) from reservation where t_id in(select t_id from ticket where type='BUSINESS')");
                ResultSet rs = st.executeQuery();
                rs.next(); %></div>
               <br> <b><center>No of people travelling in Business Class: <%=rs.getString("count(p_id)") %><br>
                </center></b>
