...
String to = request.getParameter("to");
                ...
                PreparedStatement st = conn.prepareStatement("select * from flight where  splace=? and destination=? and day=?");
                st.setString(1,from);
                st.setString(2,to);
                st.setString(3,day);
...
<td><b>Day</b></td>
                ...
                while(rs.next())
                {String n=rs.getString("totalavail");
                String p=rs.getString("nobooked");
                if(n!=p){
                %>
<tr bgcolor="#8FBC8F">
