...
<% String cost = request.getParameter("cost");
                ...
                PreparedStatement sc = conn.prepareStatement("select flight.f_id as f_id ,flight.name as name, flight.destination  as destination, flight.splace as splace ,ticket.cost as cost from flight inner join ticket on ticket.f_id=flight.f_id and ticket.cost<?");
